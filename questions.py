...
def ask_user_integer(self, loop):
    ...
    # Staattisen metodin määritys, ei tehdä olioita eli ei ole selfiä jonka sisällä on kysymys 
    # vaan se annetaan ask_user_integerille sille Annetaan kysymys ja tieto onko loop
    @staticmethod
