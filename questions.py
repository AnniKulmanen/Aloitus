...
class Question():
    ...
    def ask_user_dictionary(question, dictionary, loop):
        ...
        Args:
            ...
            dictionary (dict): Possible answer in key-value-pairs
            loop (bool): If True ask the question until able to convert it

        Returns:
            tuple: asnwer in correct type, error message, error code, detailed error
        """
        if loop == True:
            while True:
